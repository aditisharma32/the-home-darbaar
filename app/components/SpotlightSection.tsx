...
export default function SpotlightSection() {
  ...
  useGSAP(() => {
    ...
    // Pinned Horizontal Scroll trigger with a 3.5x longer scroll track to slow down translation further
    gsap.to(track, {
      x: () => -getScrollAmount(),
      ease: "none",
      scrollTrigger: {
        ...
        start: "top top",
        end: () => `+=${getScrollAmount() * 2.5}`, // 3.5x longer scroll track slows down the scroll speed further
        pin: true,
    ...
    >
      ...
      >
        ...
        {dummyImages.slice(0, 9).map((img, i) => (
          <div
            key={i}
            className={`flex-shrink-0 overflow-hidden rounded-[2px] relative group shadow-[0_20px_50px_rgba(0,0,0,0.05)] bg-brand-charcoal/5 ${i % 2 === 0
